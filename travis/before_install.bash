...
then
  ...
  echo "host      all         fbm     127.0.0.1/32          md5"      >> /etc/postgresql/$PGVERSION/main/pg_hba.conf
  echo "host      all         fbmpw      127.0.0.1/32          password" >> /etc/postgresql/$PGVERSION/main/pg_hba.conf
  echo "hostssl   all         fbmssl     127.0.0.1/32          md5"      >> /etc/postgresql/$PGVERSION/main/pg_hba.conf
  echo "host      replication fbmreplication 127.0.0.1/32      md5"      >> /etc/postgresql/$PGVERSION/main/pg_hba.conf
  echo "host      fbm fbmreplication 127.0.0.1/32      md5"      >> /etc/postgresql/$PGVERSION/main/pg_hba.conf
